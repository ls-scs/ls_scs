...
class QSTransformer2:
    ...
    def create_model(self):
        ...
        total_input = concatenate([eeout, seout], axis=1)
        tin = TimeDistributed(Dense(self.ffdims, activation="relu"))(total_input)
        ...
        decout = dtransformer_block(deout, tin)
