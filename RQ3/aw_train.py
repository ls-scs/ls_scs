...
if __name__ == '__main__':
    ...
    parser.add_argument('--action-words', dest='actionwords', type=str, default='/nfs/projects/optfuncom/data/firstwords/q75aw.pkl')
    ...
    from aw_myutils import prep, drop, batch_gen, seq2sent
    ...
    firstwords = pickle.load(open(aw, 'rb'))
    drop()
    ...
    comvocabsize = len(list(firstwords['fwmap'].keys()))
