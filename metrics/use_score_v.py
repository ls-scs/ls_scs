...
def prep_dataset(reffile, predfile, batchsize, sep):
	preds = dict()
...
if __name__ == '__main__':
	...
	parser.add_argument('--separator', dest='sep', type=str, default='<SEP>')
	...
	score = prep_dataset(comsfile, predfile, batchsize, sep)
	print(score)
